...
@WebServlet("/adminclienteditform.do")
public class AdminClientEditForm extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public AdminClientEditForm() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String viewName = "admin/client/adminclienteditform";
