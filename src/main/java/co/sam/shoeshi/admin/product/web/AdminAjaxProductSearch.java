...
@WebServlet("/adminajaxproductsearch.do")
public class AdminAjaxProductSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public AdminAjaxProductSearch() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String AdminProductSearchValue = request.getParameter("AdminProductSearchValue");
		products = dao.productSelectList(key, AdminProductSearchValue);
