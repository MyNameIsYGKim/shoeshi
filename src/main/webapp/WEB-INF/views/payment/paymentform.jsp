...
#product>.order>form>.delivery>table input[name=clientAddress] {
	width: 400px;
}
				...
				<form action="payment.do" name="form" id="form"
						...
						<tr>
							<td><article>
									<a href="productselect.do?productId=${p.productId }"><img
										src="${p.productimgPath}${p.productimgName2}"
										alt="IMG-PRODUCT"> </a>
									<div>
										<h2>
						...
						<table>
							<tr>
								...
								<td><input type="text" name="clientName"
									readonly="readonly" value="${c.clientName}"></td>
							</tr>
							<tr>
								<td>휴대폰</td>
								<td><input type="text" name="clientTel" readonly="readonly"
									value="0${c.clientTel }" maxlength="11"></td>
							</tr>

							<tr>
								<td>주소</td>
								<td><input type="text" name="clientAddress"
									readonly="readonly" value="${c.clientAddress }"></td>
							</tr>
					...
					<article class="payment">
						...
						<div>
							...
							<p>
								<label> <input type="radio" name="payment" value="신용카드">신용카드
									결제
								</label>
							...
							<p>
								<label> <input type="radio" name="payment" value="계좌이체">실시간
									계좌이체
								</label>
