		...
		<div align="center">
			...
			<div>
				<div class="row wide100000">
					<div class="tabblack col-md-4" onclick="selectBidType('BUY')" style="cursor: pointer;">
						<div class="col">
							<div class="row-sm8 numberbold numred">${count.bidCount}</div>
							<div class="menublack row-sm4">구매입찰</div>
						</div>
					</div>
					<div class="col-md-4 dealtab" onclick="location.href='bdeallist.do'"
