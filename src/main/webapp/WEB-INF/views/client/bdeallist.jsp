...
<body>
	...
	<div class="minh">
		...
		<div align="center">
			...
			<div class="row wide100000">
					<div class=" col-md-4 dealtab" onclick="selectBidType('BUY')" style="cursor: pointer;">
						<div class="col">
							<div class="row-sm8 numberbold">${count.bidCount}</div>
							<div class="menulight row-sm4">구매입찰</div>
						</div>
					</div>
					<div class="col-md-4 tabblack" onclick="location.href='bdeallist.do'"
			...
			<div>
				<table border="0">
					...
					<tbody>
						<c:if test="${empty deallistb}">
							<tr class="nodata">
								<td colspan="7">구매내역이 없습니다.</td>
							</tr>
						</c:if>
						<c:if test="${not empty deallistb}">
	...
	<div>
		<form id="dealdetailform" action="bdealdetail.do" method="get">
